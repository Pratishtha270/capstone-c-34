...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   rope = new Rope(8,{x:100,y:90});
   rope2 = new Rope(8,{x:480,y:90});

   //creating stars
   star=createSprite(40,380,20,20);
